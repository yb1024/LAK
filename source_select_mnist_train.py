...
import numpy as np
from source_select_mnist_test import test
import coral
import matplotlib.pyplot as plt
from sklearn.manifold import TSNE
import scipy.io as scio
from proxy_a_distance import proxy_a_distance
import source_select_predeal
...
if __name__ == "__main__":
    ...
    index=source_select_predeal.select_source()
    dataloader_source=eval("dataloader_source"+str(index+1))
    ...
    for epoch in range(n_epoch):
        ...
        torch.save(my_net, '{0}/mutilsource_mnist_model_epoch_{1}.pth'.format(model_root, epoch))
